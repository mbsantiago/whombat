...
__all__ = [
    "get_evaluation_sets_router",
]


def get_evaluation_sets_router(settings: WhombatSettings) -> APIRouter:
    """Get the API router for evaluation sets."""
    ...
    async def delete_evaluation_set(
        ...
        evaluation_set = await api.evaluation_sets.delete(
