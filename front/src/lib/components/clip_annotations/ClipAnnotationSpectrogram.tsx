...
import type { AnnotateMode } from "@/lib/hooks/annotation/useAnnotateClip";
import type { MotionMode as SpectrogramMode } from "@/lib/hooks/spectrogram/useSpectrogramMotions";
import type {
  ClipAnnotation,
  Position,
