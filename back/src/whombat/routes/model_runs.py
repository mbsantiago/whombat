...
__all__ = [
    "get_model_runs_router",
]


def get_model_runs_router(settings: WhombatSettings) -> APIRouter:
    ...
    @model_runs_router.post(
        "/detail/evaluate/", response_model=schemas.Evaluation
    )
